        ...
        <div className="bg-background flex flex-row items-center  justify-center px-4  shadow-lg sm:rounded-xl sm:border md:py-4 ">
          <div className="flex items-center flex-col">
            ...
            <div className="flex items-center gap-4">
              <Input
                ref={inputRef}
                className="flex-grow w-64 border-gray-400 rounded-xl "
                placeholder="Talk with Cleo"
              />
              <div
                id="voice_login"
              ...
              >
                <div className="flex flex-row gap-4 h-max">
                  <button
                    ...
                    className="mt-4 mb-4 group relative rounded-lg border-2 border-gray-400 bg-black px-5 py-2 font-medium text-white duration-1000 hover:shadow-lg hover:shadow-blue-500/50"
                  >
